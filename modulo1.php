    ...
    <div class="indexFeatElem indexTop indexLeft" style="background:none;width:1000px;">
        <div class="indexLeftImage" style="width:250px;height:300px;">
           <marquee direction="up" scrolldelay="500" class="imagenmarquee" onMouseOut="this.start()" onMouseOver="this.stop()">
            <a href="modulo1_countries.php"><img src="panet.png" class="imagenmodulo"></a>
            <a href="modulo1_numbers.php"><img src="123.png" class="imagenmodulo"></a>
            <a href="modulo1_subjects.php"><img src="class.png" class="imagenmodulo"></a>
            <a href="modulo1_family.php"><img src="fam.png" class="imagenmodulo"></a>
            <a href="modulo1_sports.php"><img src="sports.png" class="imagenmodulo"></a>
          </marquee>
        </div>
        <div class="indexRightContent" style="">
        <div class="indexRightContentQuestions questionYellow"></div>
        <a href="modulo1_countries.php"><div class="indexRightContentQuestions questionLightBlue"></div></a>
        <a href="modulo1_numbers.php"><div class="indexRightContentQuestions questionBlue"></div></a>
        ...
        <a href="modulo1_sports.php"><div class="indexRightContentQuestions questionLightBlue"></div></a>
