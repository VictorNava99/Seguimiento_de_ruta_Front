...
<!-- Seccion 1 -->
    ...
    <section class="contenmod2">

    <div class="indexFeatElem indexTop indexLeft" style="background:none;width:1000px;">
        <div class="indexLeftImage" style="width:250px;height:350px;">
           <marquee direction="up" scrolldelay="500" class="imagenmarquee" onMouseOut="this.start()" onMouseOver="this.stop()">
            <a href="modulo2_jobs.php"><img src="job.png" class="imagenmodulo"></a>
            <a href="modulo2_chores.php"><img src="quehacer.png" class="imagenmodulo"></a>
            <a href="modulo2_physical.php"><img src="body.png" class="imagenmodulo"></a>
            <a href="modulo2_parts.php"><img src="body.png" class="imagenmodulo"></a>
            <a href="modulo2_animals.php"><img src="animals.png" class="imagenmodulo"></a>
            <a href="modulo2_character.php"><img src="pasarespasar.png" class="imagenmodulo"></a>
          </marquee>
        </div>
        <div class="indexRightContent" style="">
        <div class="indexRightContentQuestions questionYellow"></div>
        <a href="modulo2_jobs.php"><div class="indexRightContentQuestions questionLightBlue"></div></a>
        <a href="modulo2_chores.php"><div class="indexRightContentQuestions questionBlue"> </div></a>
        <a href="modulo2_physical.php"><div class="indexRightContentQuestions questionLightBlue"></div></a>
        <a href="modulo2_parts.php"><div class="indexRightContentQuestions questionBlue"></div></a>
        <a href="modulo2_animals.php"><div class="indexRightContentQuestions questionLightBlue"></div></a>
        <a href="modulo2_character.php"><div class="indexRightContentQuestions questionBlue"></div></a>
