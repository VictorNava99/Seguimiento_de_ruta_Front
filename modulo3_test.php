...
<!-- Seccion 1 --><br>
   <div class="contenidoinexamen">
     <p class="formatoexamenmodulo"> MODULO</p>
   </div>
   <div class="contenidoinexamen">
    ...
    <div class="perfiltest">
      <form name="quiz">
      <p class="parrafotest">  </p>
      <p class="preguntatest"> <input type="text" name="question1"> <input type="text" name="question2"><input type="text" name="question3"> <input type="text" name="question4"> <input type="text" name="question5"> </p>
<br>
<hr>

      <p class="parrafotest"> </p>
      <p class="preguntatest"> <input type="text" name="question6"> <input type="text" name="question7"> <input type="text" name="question8"> </p>
      <p class="preguntatest"><input type="text" name="question9"> </p>
      <p class="preguntatest"> <input type="text" name="question10"> <input type="text" name="question11"></p>
      <p class="preguntatest"><input type="text" name="question12"> <input type="text" name="question13"></p>
      <p class="preguntatest"> <input type="text" name="question14"><input type="text" name="question15"> <input type="text" name="question16"></p>
...
<hr>
      ...
      <p class="parrafotest">  </p>
      <p class="preguntatest"> </p>
      <br>
     
      <ul class="radiobtn">
      <p class="preguntatest">
        <input id="radio1" type="radio" name="question21" value="True" class="radiobtn"><label for="radio1" class="radiobtn" value="True"></label>
        <input id="radio2" type="radio" name="question21" value="False" class="radiobtn"><label for="radio2" class="radiobtn" value="False"></label>
      </p>
      <p class="preguntatest"> 
        <input id="radio3" type="radio" name="question22" value="True" class="radiobtn"><label for="radio3" class="radiobtn"></label>
        <input id="radio4" type="radio" name="question22" value="False" class="radiobtn"><label for="radio4" class="radiobtn"></label>
      </p>
      <p class="preguntatest">
        <input id="radio5" type="radio" name="question23" value="True" class="radiobtn"><label for="radio5" class="radiobtn"></label>
        <input id="radio6" type="radio" name="question23" value="False" class="radiobtn"><label for="radio6" class="radiobtn"></label>
      </p>
      <p class="preguntatest"> 
        <input id="radio7" type="radio" name="question24" value="True" class="radiobtn"><label for="radio7" class="radiobtn"></label>
        <input id="radio8" type="radio" name="question24" value="False" class="radiobtn"><label for="radio8" class="radiobtn"></label>
      </p>
      <p class="preguntatest">
        <input id="radio9" type="radio" name="question25" value="True" class="radiobtn"><label for="radio9" class="radiobtn"></label>
        <input id="radio10" type="radio" name="question25" value="False" class="radiobtn"><label for="radio10" class="radiobtn"></label>
      </p>
      <p class="preguntatest">
        <input id="radio11" type="radio" name="question26" value="True" class="radiobtn"><label for="radio11" class="radiobtn"></label>
        <input id="radio12" type="radio" name="question26" value="False" class="radiobtn"><label for="radio12" class="radiobtn"></label>
      </p>
      </ul> 
