...
<!-- Seccion 1 -->
       <br>
       <p class="titulomodulo">Introduccion</p>

    <section class="contenidovocintro">
    ...
    <div class="indexFeatElem indexTop indexLeft" style="background:none;width:1000px;">
        <div class="indexLeftImage" style="width:250px;height:300px;">
           <marquee direction="up" scrolldelay="500" class="imagenmarquee" onMouseOut="this.start()" onMouseOver="this.stop()">
            <a href="intro_abc.php"><img src="abc.png" class="imagenmodulo"></a>
            <a href="intro_numbers.php"><img src="123.png" class="imagenmodulo"></a>
            <a href="intro_colors.php"><img src="colors.png" class="imagenmodulo"></a>
            <a href="intro_objects.php"><img src="utiles.png" class="imagenmodulo"></a>
            <a href="intro_language.php"><img src="class.png" class="imagenmodulo"></a>
          </marquee>
        </div>
      ...
      <article>
        ...
        <aside class="barralateralvocintro">
      <div class="indexFeatElemRight indexFact" style="width:325px;height:300px;">
        <br>
...
<!-- Deshabilitador 
    ...
    <aside class="barralateral1_mod3">
        ...
        <div class="indexRightContent" style="">
        <div class="indexRightContentQuestions questionYellow">STRUCTURES</div>
        <a href="modulo3_.php"><div class="indexRightContentQuestions questionLightBlue">What's Your name?...</div></a>
        <a href="modulo3_.php"><div class="indexRightContentQuestions questionBlue">Forma plural de los objetos</div></a>
        <a href="modulo3_.php"><div class="indexRightContentQuestions questionLightBlue">Preposiciones de lugar</div></a>
        <a href="modulo3_.php"><div class="indexRightContentQuestions questionBlue">El verbo Haber</div></a>
        <a href="modulo3_.php"><div class="indexRightContentQuestions questionLightBlue">El presente progresivo</div></a>
   ...
   <section class="contenidoexamen">
     <p class="examenmodulo"><a href="modulo1_test.php">   </a></p>
   </section> -->
